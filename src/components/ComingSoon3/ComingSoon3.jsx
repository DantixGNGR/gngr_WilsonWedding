...
return(
  ...
  <div className='blur'> 
    <div className='content'>
      ...
      <div className='text'>We are currently building this site but will be up and running 31 July 2023! Until then, you can get in touch by clicking the button below.</div>
