...
return(
  ...
  <div className='blur'> 
    <div className='content'>
      ...
      <div className='text'>We are currently building this site but will be up 30 June 2023! Until then, you can get in touch by clicking the button below. See the Save The Date by scrolling down.</div>
